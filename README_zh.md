...
说明：已移除 `Code` 列；项目与仓库链接统一放在 `Project` 列。
...
| LongGenBench: Benchmarking Long-Form Generation in Long-Context LLMs | ArXiv 2024 (arXiv preprint) | 2024-09 | [Published](https://openreview.net/forum?id=3A71qNKWAS) / [arXiv](https://arxiv.org/abs/2409.02076) | - | - | long-context, coherence |
...
| CHIRON: Rich Character Representations in Long-Form Narratives | EMNLP Findings 2024 (Findings of EMNLP) | 2024-06 | [Published](https://aclanthology.org/2024.findings-emnlp.499/) / [arXiv](https://arxiv.org/abs/2406.10190) | - | - | long-context, coherence |
