...
## Primary Sources Used for Initial Build

- User-provided paper lists and screenshots (story/novel writing, long-context coherence, sandbox/multi-agent).
- [yingpengma/Awesome-Story-Generation](https://github.com/yingpengma/Awesome-Story-Generation) for seed entries.
- Manual additions for newer long-form, sandbox, and benchmark papers.
- Official GitHub repositories for code/project links.
